...
export function fichaPayload(values, data) {
  ...
  return {
    ...
    maq_motivo: values.maquinaMotivo || null,
    ...
    hor_ini: parseOptionalNumber(values.hor_ini),
    hor_fim: parseOptionalNumber(values.hor_fim),
    km_ini: parseOptionalNumber(values.km_ini),
    km_fim: parseOptionalNumber(values.km_fim),
    diesel: parseOptionalNumber(values.diesel),
